...
void Segs::drawSegs( GLuint primitiveType, vec3 *pts, vec4 *colours, vec3 *norms, int nPts, mat4 &MV, mat4 &MVP, vec3 lightDir )

{
  ...
  glBufferData( GL_ARRAY_BUFFER, nPts * sizeof(vec4), colours, GL_STATIC_DRAW );
