...

{
  ...
  springQuadTendon = new Spring(springConstant, dampingCoefficient, femur_X, femur_Y, femur_Z, patella_X, patella_Y, patella_Z, 1);
  springPatellarTendon = new Spring(springConstant, dampingCoefficient, tibia_X, tibia_Y, tibia_Z, patella_X, patella_Y, patella_Z, 1);
